...
void Test_CFE_PSP_PortWrite8(void)
{
    ...
    */
    UtAssert_INT32_EQ(CFE_PSP_PortWrite8(0, 1), CFE_PSP_SUCCESS);
}
...
void Test_CFE_PSP_PortRead16(void)
{
    ...
    */
    uint16 Value;
    UtAssert_INT32_EQ(CFE_PSP_PortRead16(0, &Value), CFE_PSP_SUCCESS);
}
...
void Test_CFE_PSP_PortRead32(void)
{
    ...
    */
    uint32 Value;
    UtAssert_INT32_EQ(CFE_PSP_PortRead32(0, &Value), CFE_PSP_SUCCESS);
}
