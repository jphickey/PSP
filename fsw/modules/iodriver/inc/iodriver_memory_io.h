...
#ifndef CFE_PSP_IODRIVER_MEMORY_IO_H_
#define CFE_PSP_IODRIVER_MEMORY_IO_H_
...
enum
{
    ...
    CFE_PSP_IODRIVER_MEMORY_IO_READ_BLOCK,  /**< CFE_PSP_IODriver_ReadMemoryBuffer_t argument, use any appropriate access cycle (generic) */
    CFE_PSP_IODRIVER_MEMORY_IO_WRITE_BLOCK, /**< CFE_PSP_IODriver_WriteMemoryBuffer_t argument, use any appropriate access cycle (generic) */

    CFE_PSP_IODRIVER_MEMORY_IO_MAX
};


#endif /* CFE_PSP_IODRIVER_MEMORY_IO_H_ */
